...
//        Log.e(LOG_TAG, "I am bluetooth send");
        if (!isConnected()) {
...
//            Log.e(LOG_TAG, "use mOutputStream");
            try {
                mOutputStream.write(payload);
//                Log.e(LOG_TAG, "mOutputStream.write(payload) is finished");
                mOutputStream.flush();
                isSuccess = true;
            } catch (IOException e) {
...
//            Log.e(LOG_TAG, "isSuccess: " + isSuccess);
//        }
